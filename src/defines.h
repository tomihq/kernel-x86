...
#define GDT_CODE_0_SEL ((GDT_IDX_CODE_0 << 3) | (0 << 2) | 0)
#define GDT_DATA_0_SEL ((GDT_IDX_DATA_0 << 3) | (0 << 2) | 0)
#define GDT_CODE_3_SEL ((GDT_IDX_CODE_3 << 3) | (0 << 2) | 3)
#define GDT_DATA_3_SEL ((GDT_IDX_DATA_3 << 3) | (0 << 2) | 3)
/*
...
#define FLAT_SEGM_SIZE  817*1024*1024 // 817 Bytes * 1024 * 1024 = 817 MBs. Tambien podria ser 817 << 20.
#define VIDEO_SEGM_SIZE 8000          // 80 Columnas * 50 Filas * 2 (Para cualquier ASCII + atributos)
...
#define TASK_STACK_TOP 0x08002000
