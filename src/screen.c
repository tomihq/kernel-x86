...
void screen_draw_layout(void) {
  /*
    Los atributos tienen el siguiente protocolo:
    - [0:4) = Color de texto.
    - [4:7) = Color de fondo.
    - [7:8) = Parpadeo (???), generalmente en desuso.
  */
  screen_draw_box(0, 0, VIDEO_FILS, VIDEO_COLS, ' ', 0);                    // Limpia todo el buffer de video.
  screen_draw_box(1, 1, VIDEO_FILS - 2, VIDEO_COLS - 2, '*', 0 << 7 | 1 << 4 | 15); // Dibuja un rectangulo bonito.
  screen_draw_box(2, 2, VIDEO_FILS - 4, VIDEO_COLS - 4, ' ', 0);                    // Limpia el interior del rectangulo bonito.

  print("Eliel Nicolas Spinosa Recalde", 3, 3, 0 << 7 | 0 << 4 | 15);
  print("El titan de Tomi", 3, 5, 0 << 4 | 15); // Personalicen su nombre
  print("El titan de Agus", 3, 7, 0 << 4 | 15); // Personalicen su nombre
}